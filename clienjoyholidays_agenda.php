...
/**
 *  \file       clienjoyholidays_agenda.php
 *  \ingroup    clienjoyholidays
 *  \brief      Tab of events on CliEnjoyHolidays
 */
...
if ($object->id > 0) {
	$title = $langs->trans("CliEnjoyHolidays")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("CliEnjoyHolidays"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_clienjoyholidays_'.$object->id;
