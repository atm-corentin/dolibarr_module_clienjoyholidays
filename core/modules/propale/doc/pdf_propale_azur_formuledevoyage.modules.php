 ...
 */
class pdf_propale_azur_formuledevoyage extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "azur_formuledevoyage";
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		*/
		...
		if (!empty($object->array_options['options_clienjoyholidays_specificmention'])) {
