...
/**
 *  \file       core/modules/clienjoyholidays/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_clienjoyholidays
 */
class pdf_standard_clienjoyholidays extends ModelePDFCliEnjoyHolidays
{
	/**
	 ...
	 *
	 *  @param		CliEnjoyHolidays	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  CliEnjoyHolidays	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('CLIENJOYHOLIDAYS_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('CLIENJOYHOLIDAYS_DRAFT_WATERMARK')));
		}
