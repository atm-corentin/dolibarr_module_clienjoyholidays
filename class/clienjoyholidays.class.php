...
//	public $module = 'clienjoyholidays';
	...
	//  */
	// public $table_element_line = 'clienjoyholidays_clienjoyholidaysline';

	// /**
	//  * @var string    Field with ID of parent key if this object has a parent
	//  */
	// public $fk_element = 'fk_clienjoyholidays';

	// /**
	//  * @var string    Name of subtable class that manage subtable lines
	//  */
	// public $class_element_line = 'CliEnjoyHolidaysline';

	// /**
	//  * @var array	List of child tables. To test if we can delete object.
	//  */
	// protected $childtables = array('mychildtable' => array('name'=>'CliEnjoyHolidays', 'fk_element'=>'fk_clienjoyholidays'));
	...
	//  */
	// protected $childtablesoncascade = array('clienjoyholidays_clienjoyholidaysdet');

	// /**
	//  * @var CliEnjoyHolidaysLine[]     Array of subtable lines
	//  */
	// public $lines = array();
...
//		 }
	...
	public function getNextNumRef()
	{
		...
		if (!getDolGlobalString('CLIENJOYHOLIDAYS_MYOBJECT_ADDON')) {
			$conf->global->CLIENJOYHOLIDAYS_MYOBJECT_ADDON = 'mod_clienjoyholidays_standard';
		}
