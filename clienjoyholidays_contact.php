...
/**
 *  \file       clienjoyholidays_contact.php
 *  \ingroup    clienjoyholidays
 *  \brief      Tab for contacts linked to CliEnjoyHolidays
 */
...
$title = $langs->trans("CliEnjoyHolidays")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("CliEnjoyHolidays"), -1, $object->picto);
