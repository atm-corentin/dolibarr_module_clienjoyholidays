...
/**
 *  \file       clienjoyholidays_note.php
 *  \ingroup    clienjoyholidays
 *  \brief      Tab for notes on CliEnjoyHolidays
 */
...
$title = $langs->trans('CliEnjoyHolidays').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("CliEnjoyHolidays"), -1, $object->picto);
